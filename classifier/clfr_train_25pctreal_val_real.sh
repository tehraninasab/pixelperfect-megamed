...
#SBATCH --job-name=25pct_real_only
#SBATCH --output=/home/a/amarkr1/workshop/megamed/logs/slurm-25pct-real-only-%j.out
#SBATCH --time=2:00:00
...
TRAIN_CSV="datasets/chexpert_highres_synthetic/real_only_25pct.csv"
...
SYNTHETIC_ROOT="."
BASE_DIR="classifier/results_train_25pctrealonly_val_real"
NUM_WORKERS=4
LEARNING_RATE=1e-4
NUM_EPOCHS=10
NUM_GPUS=4
