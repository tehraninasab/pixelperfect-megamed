...
TRAIN_CSV="datasets/chexpert_highres_synthetic/synthesized_images_sdxl_chexpert_dreambooth_lora_rank8_without_text_interactive_epoch_3_0_-1_32_set1.csv"
...
SYNTHETIC_ROOT="."
BASE_DIR="classifier/results_clfr_highres_rerun2"
NUM_WORKERS=4
LEARNING_RATE=1e-4
NUM_EPOCHS=10
NUM_GPUS=4
...
run_training() {
    ...
    # Build command
    local cmd="CUDA_VISIBLE_DEVICES=${gpu_id} python classifier/train_chexpert.py \
        --train_csv ${TRAIN_CSV} \
