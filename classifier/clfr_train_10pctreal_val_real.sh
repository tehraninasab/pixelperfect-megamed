...
#SBATCH --job-name=10pct_real_only
#SBATCH --output=/home/a/amarkr1/workshop/megamed/logs/slurm-10pct-real-only-%j.out
#SBATCH --time=1:30:00
...
TRAIN_CSV="datasets/chexpert_highres_synthetic/real_only_10pct.csv"
...
SYNTHETIC_ROOT="."
BASE_DIR="classifier/results_train_10pctrealonly_val_real"
NUM_WORKERS=4
LEARNING_RATE=1e-4
NUM_EPOCHS=10
NUM_GPUS=4
