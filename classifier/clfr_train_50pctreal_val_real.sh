...
#SBATCH --job-name=50pct_real
#SBATCH --output=/home/a/amarkr1/workshop/megamed/logs/slurm-50pct-real-%j.out
#SBATCH --time=2:30:00
...
TRAIN_CSV="datasets/chexpert_highres_synthetic/real_only_50pct.csv"
...
SYNTHETIC_ROOT="."
BASE_DIR="classifier/results_train_50pctrealonly_val_real"
NUM_WORKERS=4
LEARNING_RATE=1e-4
NUM_EPOCHS=10
NUM_GPUS=4
