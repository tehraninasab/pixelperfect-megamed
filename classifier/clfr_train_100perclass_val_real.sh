...
#SBATCH --job-name=500per_class_plus_synthetic
#SBATCH --output=/home/a/amarkr1/workshop/megamed/logs/slurm-500per_class_plus_synthetic-real-only-%j.out
#SBATCH --time=1:30:00
...
TRAIN_CSV="datasets/chexpert_highres_synthetic/balanced_class_datasets/balanced_real_500_plus_synthetic.csv"
VAL_CSV="datasets/chexpert_highres/visualCheXbert_val.csv"
TEST_CSV="datasets/chexpert_highres/visualCheXbert_test.csv"
REAL_ROOT="/scratch/a/amarkr1/data"
SYNTHETIC_ROOT="."
BASE_DIR="classifier/results_train_balanced500plussynt_val_real"
NUM_WORKERS=4
LEARNING_RATE=1e-4
NUM_EPOCHS=10
NUM_GPUS=4
